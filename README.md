...
2\. \*\*Instala la librería de tipos:\*\* Como he usado '@typechecked' para que los datos sean correctos, tienes que instalar esto en la terminal: pip install typeguard
...
\*\*Cómo probarlo:\*\* Al final del archivo .py he creado una función llamada inicializar\_inventario(). Ahí he metido unos cuantos libros de prueba para comprobar que las validaciones y el stock funcionan bien nada más arrancar.
...
!\[Diagrama de Clases del Sistema](./Diagrama.png)
